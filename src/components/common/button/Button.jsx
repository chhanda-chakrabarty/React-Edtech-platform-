...
function Button({ children, text, variant, className }) {
  ...
  return (
    <button
      className={`${className} font-primary flex cursor-pointer items-center justify-center gap-[10px] rounded-full text-base font-medium transition duration-300 ease-in-out ${variantStyles[variant]}`}
    >
